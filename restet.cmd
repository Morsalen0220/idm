...
cls
title  IDM Activation v-clean - apple
mode 90, 30
...
echo:          Create By Morsalen Apple
echo:          _____________________________________________   
echo: 
echo:          Telegram: @Morsalen0220
echo:          Github: https://github.com/Morsalen0220/idm
echo:          _____________________________________________   
echo: 
echo:          [1] Activate IDM                                 
...
echo:
timeout /t 3
start https://github.com/Morsalen0220/
exit /b
::========================================================================================================================================
...
set "reg=HKCU\SOFTWARE\DownloadManager /v FName /t REG_SZ /d "morsaln"" & call :_rcont
set "reg=HKCU\SOFTWARE\DownloadManager /v LName /t REG_SZ /d "apple"" & call :_rcont
set "reg=HKCU\SOFTWARE\DownloadManager /v Email /t REG_SZ /d "morsalen0220@gmail.com"" & call :_rcont
...
_________________________________
   ...
   Homepage:	https://github.com/Morsalen0220/idm
 
   Telegram:	Morsalen0220
